...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_5.setGeometry(QRect(10, 10, 41, 21))
...
"color:black")
        ...
        self.lblStatusLogin.setGeometry(QRect(60, 10, 171, 21))
        ...
        self.lblTitleSisaQuota.setGeometry(QRect(10, 40, 81, 21))
        self.lblTitleSisaQuota.setStyleSheet(u"font-weight: bold;\n"
"color:black")
        self.lblSisaKuota = QLabel(self.frame)
        self.lblSisaKuota.setObjectName(u"lblSisaKuota")
        self.lblSisaKuota.setGeometry(QRect(80, 40, 81, 21))
        self.lblSisaKuota.setStyleSheet(u"font-weight: bold;\n"
"color:red")
